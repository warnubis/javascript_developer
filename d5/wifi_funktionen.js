...
var hideElementData = function( idElement) {
  document.getElementById(idElement).className = 'page';
}

var showElementData = function( idElement) {
  document.getElementById(idElement).className = 'page page-visible';
}

var changeElementData = function ( idElement, visible) {
  if (visible) {
    showElementData(idElement);
  }
  else hideElementData(idElement);
}
